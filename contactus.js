...
dbo.collection("agents").find(query, {projection : {_id: 0, AgtFirstName : 1, AgtLastName: 1, AgtEmail: 1, AgtBusPhone:1 }}).toArray(function(err, result) {
  ...
  res.write('<div class="col-lg-4 col-sm-6 mb-3"> <div class="thumbnail"><div class="card" style="width:300px">'
    +'<img class="card-img-top" src="https://images.pexels.com/photos/1065084/pexels-photo-1065084.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500"style="width:100%" /><div class="card-body"><h4 class="card-title text-center">'+ x[0].AgtFirstName + " "+ x[0].AgtLastName+ '</h4><p class="card-text">'
  ...
  res.write('<div class="row"><div class="col-lg-4 col-sm-6 mb-3"> <div class="thumbnail"><div class="card" style="width:300px">'
    +'<img class="card-img-top" src="https://www.lorealparisusa.com/~/media/images/lop/wow-data/honorees/2018/loreal-paris-wow-honorees-bios-main-alisha-zhao.jpg" style="width:100%"><div class="card-body"><h4 class="card-title text-center">'+ x[1].AgtFirstName + " "+ x[1].AgtLastName+ '</h4><p class="card-text">'
  ...
  res.write('<div class="col-lg-4 col-sm-6 mb-3"> <div class="thumbnail"><div class="card" style="width:300px">'
    +'<img class="card-img-top" src="agentt5.jpg" style="width:100%"><div class="card-body"><h4 class="card-title text-center">'+ x[3].AgtFirstName + " "+ x[3].AgtLastName+ '</h4><p class="card-text">'
  ...
  res.write('<div class="col-lg-4 col-sm-6 mb-3"> <div class="thumbnail"><div class="card" style="width:300px">'
    +'<img class="card-img-top" src="agentt5.jpg" style="width:100%"><div class="card-body"><h4 class="card-title text-center">'+ x[4].AgtFirstName + " "+ x[4].AgtLastName+ '</h4><p class="card-text">'
